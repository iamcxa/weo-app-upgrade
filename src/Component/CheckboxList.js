...
const styles = StyleSheet.create({
  checkBox: {
    ...
    alignItems: "center",
    width: Screen.scale(21),
    height: Screen.scale(21),
        ...
        <View style={{}}>
          <CheckBox
            rightTextStyle={{
              ...
              marginTop: Screen.scale(7.5),
              marginBottom: Screen.scale(7.5),
              marginLeft: Screen.scale(10),
            }}
            onClick={() => {
              this.setClick(i);
            }}
