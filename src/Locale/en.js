export default {
  ...
  __alert_request_failed_content: 'Please check network connection and try again',
  ...
  __alert_reply_bar_message_content_not_allowed: 'Using inappropriate words, still wanna post?',
  ...
  _notification_geolocation_detection_body: 'WeO is looking for Circles near by...',
  _notification_someone_reply_your_topic_title: 'Your topic got a new reply',
  _notification_someone_reply_your_topic_body: '%{memberName} posted at「%{topicTitle}」...',
  _notification_someone_reply_your_post_title: 'Your topic got a new reply',
  _notification_someone_reply_your_post_body: '%{memberName} replied at「%{postTitle}」...',
  _notification_someone_vote_title: 'Someone %{voteType} your Topic 「%{postTitle}」',
  _notification_someone_vote_body: 'Your reply at「%{content}」got a %{voteType} ...',
  ...
  permission_unsupported_content: 'Permission %{permission} ns not unsupported.',
  ...
  permission_request_desc_location: 'Let WeO access your location to assign you to a Circle',
  ...
  app_route_data_wont_save_if_cancel: 'You will lose the content, do you still wanna cancel?',
  ...
  peek_topic_list_list_is_empty: 'No one has ever posted at this Circle. Be the first one!',
  ...
  create_topic_input_text_blocked: 'Using inappropriate words, still wanna post?',
  create_topic_max_word_length: '%{length} characters',
  create_topic_submit: 'POST',
  create_topic_interval_too_short: 'You have to wait %{period} seconds to create new content.',
  ...
  search_list_empty: "No one has ever talked about this here, let's be the FIRST one!",
  there_you_are_intro_alert_set_fav_circle_title: 'Chosen?',
  there_you_are_intro_alert_set_fav_circle: 'Set %{circleName} as your Favorite Circle?',
  ...
  faq_question_5_answer: 'Talk with respect. Please report person attack and illegal post.',
  ...
  topic_list_no_circle:
    'You are not located at any Circle Now. Go to spy only to see where are the Circles!',
  topic_list_no_location_permission_1: 'Giving location permission in order to discuss',
  topic_list_no_location_permission_2: 'Or go to Spy View to see where are the Circles!',
