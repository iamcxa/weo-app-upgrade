...
import DefaultTabBar from "~/Component/ScrollableDefaultTabBar";
        ...
        <ScrollableTabView
          ...
          renderTabBar={(props) => {
            ...
            const underlineStyle = {
              width: Screen.scale(20),
              backgroundColor: Colors.pink,
              marginLeft: tabWidth / 2 - Screen.scale(20) / 2,
            };
            return (
              <DefaultTabBar
                style={{
                  height: Screen.scale(52),
                  paddingTop: Screen.scale(10),
                }}
                textStyle={{ fontSize: Screen.scale(14) }}
                underlineStyle={underlineStyle}
                underlineWidth={Screen.scale(20)}
              />
            );
          }}
        >
