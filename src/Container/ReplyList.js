...
import {
  ...
  deleteReplyById,
  createReply,
} from "~/Store/List/Actions/reply";
import { updatePostByKey, deletePostById } from "~/Store/List/Actions/post";
...
const replyBarHeight = Screen.scale(REPLY_BAR_HEIGHT);
...
const styles = StyleSheet.create({
  ...
  listHeader: {
    marginHorizontal: Screen.scale(28),
